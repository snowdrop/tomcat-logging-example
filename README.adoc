...
----
include::./src/main/java/me/snowdrop/logging/TomcatLoggingApplication.java[tags=snippet-container]
----
...
----
include::./src/main/java/me/snowdrop/logging/TomcatLoggingApplication.java[tags=snippet-listener]
----
